...
$query = "UPDATE wages ";
$query .= "SET prevailing_wage = '$prevailing_wage', ";
$query .= "pw_unit_of_pay = '$pw_unit_of_pay', ";
$query .= "pw_wage_level = '$pw_wage_level', ";
$query .= "pw_source = '$pw_source', ";
$query .= "pw_source_year = '$pw_source_year', ";
$query .= "pw_source_other = '$pw_source_other', ";
$query .= "wage_rate_of_pay_from = '$wage_rate_of_pay_from', ";
$query .= "wage_rate_of_pay_to = '$wage_rate_of_pay_to', ";
$query .= "wage_unit_of_pay = '$wage_unit_of_pay' ";
